...
namespace Photon.Pun
{
    ...
    public class PhotonTransformView : MonoBehaviour, IPunObservable
    {
        ...
        public void Update()
        {
            ...
            {
                transform.position = Vector3.MoveTowards(transform.position, this.m_NetworkPosition, this.m_Distance * (1.5f / PhotonNetwork.SerializationRate));
                transform.rotation = Quaternion.RotateTowards(transform.rotation, this.m_NetworkRotation, this.m_Angle * (1.5f / PhotonNetwork.SerializationRate));
            }
        }
